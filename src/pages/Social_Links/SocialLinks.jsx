      ...
      <div className="contentPage">
        ...
        <div className="rootContainer">
          <div className="gridContainer">
            <a className='logo' href="https://www.instagram.com/RishikeshKarkhanis" onClick={window.open("https://www.instagram.com/RishikeshKarkhanis")}><img src="Logo" alt="Logo" srcset={insta} /></a>
