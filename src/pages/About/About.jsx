      ...
      <div className="contentPage">
        ...
        <div className="desc">
          <p>Hello! I'm Rishikesh Karkhanis, a passionate and dedicated student pursuing B.Tech in Computer Science & Engineering (AIML) at Acropolis Institute of Technology & Research, Indore.
            While my primary focus is on Artificial Intelligence & Machine Learning, I have a strong interest in Web Development as well. I enjoy building innovative and functional web applications, and I’ve worked on projects like MICRO-URL, TaskDone, and more.
